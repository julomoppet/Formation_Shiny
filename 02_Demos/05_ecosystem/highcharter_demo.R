...
ui <- fluidPage(
    h1("Démo de Highcharter"),
    fluidRow(
        column(width = 4, class = "panel",
               selectInput("type", label = "Type de graph", width = "70%",
                           choices = c("line", "column", "bar", "spline")), 
               selectInput("stacked", label = "Empilé?",  width = "70%",
                           choices = c(FALSE, "normal", "percent")),
               selectInput("theme", label = "Thème à appliquer",  width = "70%",
        ...
        column(width = 8,
               highchartOutput("hcontainer",height = "450px")
        )
    )
)
